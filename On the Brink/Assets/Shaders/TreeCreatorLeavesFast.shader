...
Shader "Nature/Tree Creator Leaves Fast Cel" {
Properties {
    ...
    _HighColorThreshold("High Light Threshold", Range(0, 1)) = 0.5
...
SubShader {
    ...
    CGPROGRAM
        ...
        fixed4 FragmentLeaf (v2f_leaf IN) : SV_Target
        {
            ...
            if (light.r > _HighColorThreshold) {
                return fixed4(_HighColor.rgb, 0.0);
            } else {
                return fixed4(_LowColor.rgb, 0.0);
            }
        }
